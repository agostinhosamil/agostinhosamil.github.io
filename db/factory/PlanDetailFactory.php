...
namespace Sami\Base {
  ...
  # EG: The curreent Factory (PlanDetailFactory[Factory])
  # with automatically point to a User model.
  Factory::Define ('PlanDetailFactory', function (Faker $faker) {
    # Create a fake random PlanDetailFactory,
    # by an instance of 'Fake'
    # class;
    # it should be an array containg
    # the PlanDetailFactory datas.
    $plandetail = new Fake ();
